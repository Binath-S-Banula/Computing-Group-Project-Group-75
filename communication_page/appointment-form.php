...
$sql = "SELECT * FROM lecturer_schedule ORDER BY lecturer_name, day_of_week, time_range";
...
<main>
    <div class="form-container">
        <h2>Submit Your Lecturer Appointment Booking Details</h2>
        <form action="submit-appointment.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="lecturer" name="lecturer" required>
                    ...
                    <?php
                    // Populate the select options with available lecturer schedules
                    while ($row = $result->fetch_assoc()) {
                        // Combine lecturer name, schedule day, time, and room into one string
                        $lecturer_info = $row['lecturer_name'] . ' - ' . $row['day_of_week'] . ' ' . $row['time_range'] . ' - Room: ' . $row['room'];
